...
Go to Admin => Tools =>Install SQL patches page. Upload the erase_stripe_recordes.sql file or paste php code TRUNCATE ` stripe `; in the "Enter the query to be executed:"text box. and press "Send" button.');
} else {
